...
const casesTransformers = [
  { label: 'Chữ hoa', value: (value: string) => value.toUpperCase() },
  { label: 'Chữ thường', value: (value: string) => value.toLowerCase() },
];
...
<template>
  <div flex flex-col justify-center gap-2>
    <div flex items-center>
      <label w-150px pr-12px text-right> Số lượng:</label>
